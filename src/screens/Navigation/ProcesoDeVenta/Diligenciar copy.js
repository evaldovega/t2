...
import PlanFormulario from './components/PlanFormulario';
import PasarelaPago from './components/Finalizar/PasarelaPago';
...
class NegocioDiligenciarInformacion extends React.Component {
  state = {
    btn_txt: 'Vender',
    marginTop: 1,
    amount: 0,
