...
import {View, ScrollView, StyleSheet, TouchableOpacity, Picker, Text, Alert, Switch, Linking} from "react-native";
                    ...
                    <View style={styles.containerSignIn}>
                        <View style={{flex:1}}>
                            <Text>
                                ...
                                <Text style={styles.link} onPress={()=>Linking.openURL('https://google.com')}> contrato de carrotaje </Text>
                            </Text>
                        </View>
                        <Switch
                            trackColor={{ false: COLORS.PRIMARY_COLOR, true: COLORS.SECONDARY_COLOR_LIGHTER }}
